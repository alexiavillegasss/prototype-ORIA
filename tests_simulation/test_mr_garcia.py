...
async def run_test():
    ...
    print("--- Lancement du test ORIA : Cas M. Garcia ---")
    ...
    text = "M. Garcia, 80 ans, habite à Sanary-sur-Mer. Il était très autonome jusqu'à son AVC il y a 3 semaines. Depuis sa sortie d'hôpital, il a chuté deux fois. Sa femme de 78 ans essaie de l'aider pour la toilette et les repas mais elle est épuisée et commence à avoir des problèmes de dos. Il y a beaucoup d'intervenants (infirmiers, kiné, aide ménagère) mais ils ne se coordonnent pas et les consignes sont contradictoires, ce qui stresse énormément le couple."
    ...
    print(f"\n4. Recherche des contacts territoriaux ({extracted_data.get('usager.localisation.commune_residence', 'Sanary-sur-Mer')})...")
    commune = extracted_data.get('usager.localisation.commune_residence', 'Sanary-sur-Mer')
