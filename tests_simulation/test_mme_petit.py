...
async def run_test():
    ...
    print("--- Lancement du test ORIA : Cas Mme Petit (Urgence CCAS) ---")
    ...
    print(f"\n--- RESULTATS DE L'ORIENTATION (Territoire: {commune}) ---")
