...
async def run_test():
    ...
    print("--- Lancement du test ORIA : Cas Mme Durand ---")
    ...
    text = "Mme Durand, 88 ans, vit à Hyères. Elle est très confuse, elle déambule la nuit dans l'immeuble. Elle est agressive avec les infirmiers qui viennent pour son diabète et refuse qu'ils entrent. Elle a déjà l'APA mais le plan d'aide actuel ne suffit plus du tout. Ses voisins s'en plaignent et la situation devient dangereuse."
