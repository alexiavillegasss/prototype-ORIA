...
async def run_test():
    ...
    print("--- Lancement du test ORIA : Cas Mme Georgette Mouton (Ollioules) ---")
    ...
    text = (
        "Mme Georgette Mouton, 83 ans, vit seule à Ollioules dans un appartement devenu extrêmement insalubre "
        "et encombré de déchets et d'objets accumulés (syndrome de Diogène). Elle est en situation de grand isolement social "
        "et n'a aucun aidant à proximité. L'infirmière libérale qui passe pour son traitement contre l'hypertension "
        "signale un risque majeur de chute et de fréquents oublis de médicaments (mise en danger). "
        "De plus, elle n'a plus de médecin traitant depuis 6 mois et ne bénéficie pas de l'APA."
    )
    ...
    results_with_contacts = territory_manager.get_contacts_for_structures(orientation_results, "Ollioules")
