...
async def run_test():
    ...
    print("--- Lancement du test ORIA : Cas M. Leroy (Moins de 60 ans) ---")
    ...
    text = "M. Leroy, 45 ans, habite à Toulon. Il est atteint d'une Sclérose en Plaques (SEP) diagnostiquée il y a 2 ans. Sa santé se dégrade rapidement et il a dû arrêter son activité professionnelle. Il vit seul, ses revenus ont chuté et il a du mal à payer son loyer. Il se sent perdu dans son parcours de soins entre les différents spécialistes et son moral est au plus bas, il exprime des idées noires."
    ...
    print(f"\n--- RESULTATS DE L'ORIENTATION (Age: {extracted_data.get('usager.identite.age_estime')} ans) ---")
