...
async def run_test():
    ...
    print("--- Lancement du test ORIA : Cas Mme Rossi (Violences Conjugales) ---")
    ...
    text = "Mme Rossi, 70 ans, habite à Toulon. Elle vient d'appeler car elle a dû quitter son domicile en urgence. Son mari est devenu très violent physiquement et verbalement. Elle est actuellement cachée chez une amie. Elle n'a pas accès à ses comptes bancaires et a besoin d'être protégée et de trouver un hébergement d'urgence."
